...
file_path = os.path.join(base_path, '..', 'report', 'keyword', 'kw_node_level_analysis.csv')
...
if os.path.exists(absolute_path):
    ...
    output_path = os.path.join(base_path, '..', 'report', 'keyword', 'keywords_ordered_by_degree_centrality.csv')
